        ...
        <div className="container-top">
          <div className="row">
            <div className="col-lg-6">
              <h1 className="big-heading">Looking for a <br />lollipop atternative?</h1>
              ...
              <button type="button" className="btn btn-primary btn-lg btnrow">Primary CTN</button>
              <button type="button" className="btn btn-secondary btn-lg btnrow">Secondary CTN</button>
            </div>
            <div className="col-lg-6">
